...
function SubtitleSettingPage(params,srcModule)
{
	...
	var mainParam = [
		...
		{uiType:UILabel,w:width_frame,h:50,ol:0,ot:2,dt:10,HAlign:"center",font:font2,value:Lp.getValue("Personal_Settings")+">"+Lp.getValue("Subtitle_Setting2")},
        ...
        {uiType:UILabel,id:"language_title",w:width_title*(1+0.4),h:height_label,ol:left_title-100,ot:top_label+height_label+15,value:Lp.getValue("Main_Subtitle")+":",font:font1,HAlign:"right"},
		{uiType:UIButton, id:"language_button",w:width_con,h:height_con,ol:left_con,ot:top_con+height_con+10,dt:5,value:languageArr,HAlign:"center",font:font1,onFocus:true,styleClass:"setting_select_item"},
	...
	this.initView = function(){
		...
		var index2 = sysCom.config.mainLanguage;
		mainDlg.getChild("switch_button").vIndex = index;
		mainDlg.getChild("language_button").vIndex = index2;
		self.win.update();
	}
	...
	function saveConfig(){
		...
		var index2 = mainDlg.getChild("language_button").vIndex;
		sysCom.config.subtitleStatus = index;
		sysCom.config.mainLanguage = index2;
		sysCom.saveConfig();
		showTips();
	}
